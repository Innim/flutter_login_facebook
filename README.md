...
* iOS: **18.0.3** ([CocoaPods](https://cocoapods.org/pods/FBSDKLoginKit))
* Android: **18.1.3** ([Maven](https://search.maven.org/artifact/com.facebook.android/facebook-android-sdk))

## Minimum requirements

* iOS **13.0** and higher.
* Android **7.0** and newer (SDK **24**).
